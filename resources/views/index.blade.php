...
@endsection
@section('css')
    <link rel="stylesheet" href="{{mix('/css/package.css', 'vendor/processmaker/packages/spark-package-skeleton')}}">
@endsection
@section('content')
...
@section('js')
<script src="{{mix('/js/package.js', 'vendor/processmaker/packages/spark-package-skeleton')}}"></script>
@endsection
@endsection
